...
<div class="card" style="max-width: 800px; margin: 0 auto; border-left: 5px solid #2b7a0b;">
    <h3 style="color: #1E4620; font-weight: 700;">✏️ Edit Penyakit Sawit</h3>
    ...
    <form action="{{ route('admin.penyakit.update', $penyakit->id) }}" method="POST" enctype="multipart/form-data" style="margin-top: 20px;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            @if($penyakit->image)
                <div style="margin-bottom: 10px; padding: 10px; border: 1px dashed #cbd5e1; border-radius: 8px; display: inline-block;">
                    ...
                    <img src="{{ $penyakit->image_url }}" alt="Current" style="width: 200px; height: 150px; object-fit: cover; border-radius: 8px;">
                </div>
            @endif
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="description" rows="4" 
                      class="custom-input">{{ $penyakit->description }}</textarea>
        </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="solution" rows="4" 
                      class="custom-input">{{ $penyakit->solution }}</textarea>
        </div>
